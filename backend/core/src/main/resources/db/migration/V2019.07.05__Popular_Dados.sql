...
VALUES (
   gen_random_uuid(), 'Ambiente de Desenvolvimento', 'http://localhost:4200/controle', 'DESENVOLVIMENTO', currval('sistema_id_seq'), 'com.github.andrepenteado.sso.controle', '2023-01-01 00:00:00.000000',
...
INSERT INTO public.oauth2_registered_client (
    ...
    authorization_grant_types, redirect_uris, post_logout_redirect_uris, scopes, client_settings, token_settings)
VALUES (
   gen_random_uuid(), 'Ambiente de Desenvolvimento', 'http://localhost:4200/portal', 'DESENVOLVIMENTO', currval('sistema_id_seq'), 'com.github.andrepenteado.sso.portal', '2023-01-01 00:00:00.000000',
