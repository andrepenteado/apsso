...
VALUES (
   'Controle', 'Módulo de cadastro de usuários e sistemas', now(), 'https://controle.apcode.com.br', 'com.github.andrepenteado.sso.controle', '2023-01-01 00:00:00.000000', '{bcrypt}$2a$10$xG.KPzsgZddwndKL9AQWquv1FdQW232DWRcC2GSLtr34aUaEEUOOa',
...
INSERT INTO public.oauth2_registered_client (
    ...
    authorization_grant_types, redirect_uris, post_logout_redirect_uris, scopes, client_settings, token_settings)
VALUES (
   'Portal', 'Portal de Sistemas', now(), 'https://portal.apcode.com.br', 'com.github.andrepenteado.sso.portal', '2023-01-01 00:00:00.000000', '{bcrypt}$2a$10$iJMyj3siGWVf1OARieTkAeynUscGkapD9Giu/PjkEVnKod/0PF.dC',
