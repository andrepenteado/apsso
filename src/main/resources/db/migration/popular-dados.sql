...
(client_id, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities,
 access_token_validity, refresh_token_validity, additional_information, autoapprove)
VALUES ('com.gitlab.andrepenteado.controle', '$2a$10$qm2SDJrtELnkXfo2fKCGkOjuhZ5pV6G07B3b84CDs57W7cD7Kb/ga', 'user_info', 'authorization_code', 'http://localhost:8080/controle/login', null, 36000, 36000, null, true);
