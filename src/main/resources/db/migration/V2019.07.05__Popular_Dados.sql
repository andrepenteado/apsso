...
VALUES ('com.gitlab.andrepenteado.apcontrole', '$2a$10$G622aCJHYgPGSibSVWReWeLLQwmd94n245KIeTeJeOazmYt5Sq9yi', 'user_info', 'authorization_code', 'http://localhost:30001/ap-controle/login', null, 36000, 36000, null, true);
